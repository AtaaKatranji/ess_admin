    ...
    <div className="container mx-auto p-4">
      ...
      <div className="space-y-6">
        {leaveRequests.map((request) => (
          <div key={request._id} className="bg-white shadow rounded-lg p-6 border border-gray-200">
            ...
            {expandedRequest === request._id && (
              <div className="border-t pt-4 space-y-3 text-gray-700">
                <div className="grid grid-cols-2 gap-4">
                  <p>
                    <span className="font-semibold">Start Date:</span> {request.startDate}
                  </p>
                  <p>
                    <span className="font-semibold">End Date:</span> {request.endDate}
                  </p>
