              ...
              >
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      ...
                      aria-label="Expand details"
                    >
                      {expandedHourlyLeave === leave._id ? <ChevronUp size={20} /> : <ChevronDown size={20} />}
                    </button>
                  </div>
                </div>
                ...
                {expandedHourlyLeave === leave._id && (
                  <div className="border-t pt-4 space-y-3 text-gray-700">
                    <div className="grid grid-cols-2 gap-4">
                      <p>
                        <span className="font-semibold">Start Time:</span> {formattedTime(leave.startTime)}
                      </p>
                      <p>
                        <span className="font-semibold">End Time:</span> {formattedTime(leave.endTime)}
                      </p>
                      <p>
                        <span className="font-semibold">Duration:</span> {leave.duration} hours
                      </p>
                    </div>
