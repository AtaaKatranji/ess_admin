...
function LayoutBody({ children, slug }: { children: React.ReactNode; slug: string }) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen min-h-0 min-w-0 overflow-hidden bg-gray-100">
      ...
      <main className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="w-full max-w-full overflow-hidden px-3 sm:px-6 pt-14 md:pt-6 pb-6">
          {children}
          <ToastContainer />
        </div>
      </main>
